  ...
  <div class="customer-box">
      ...
      <el-row>
        <el-col :span="24">
          <el-row type="flex" justify="space-around">
            <el-col :span="14">
              <el-select class="selectStyle" size="small" v-model="value" placeholder="套餐规格">
                <el-option v-for="item in $store.state.simList" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            ...
            <el-col :span="7" style="display:flex;">
              <el-button type="primary" class="search" size="small" @click="piLiang = true">批量搜索</el-button>
    ...
    <div class="filter-table-wrap">
      <el-table :data="tableData" stripe style="width: 100%" height="calc(100% - 70px)">
        ...
        <el-table-column type="index" min-width="100" label="序号">
        </el-table-column>
      ...
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage" :page-sizes="[50, 100]" :page-size="50" layout="total, sizes, prev, pager, next, jumper" :total="500">
      </el-pagination>
    </div>
    <!-- 关停日期 -->
        ...
        <div class="item-right">
          <el-dropdown placement="bottom-start" @command="handleCommand" trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item :command="item.gprsType" v-for="(item,index) in simList" :key="index">{{item.gprsType}}</el-dropdown-item>
