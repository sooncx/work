<template>
  <div  class="app-wrap">
    <div class="obdVue-wrap">
      ...
      <div class="tab-cont" :class="[errorMsg&&!isLoading?'error-wrap':'']" v-loading="isLoading"  element-loading-text="正在获取车辆信息" >
          <template v-if="!errorMsg">
            <section class="obdDetail-chunk">
              <div class="chunk-title">基本信息</div>
            ...
            <section class="obdDetail-chunk" v-if="false">
                <div class="chunk-title">车身信息</div>
                <div class="chunk-cont">
          ...
          <template v-if="errorMsg">
              <div class="error-box">
                  ...
                  <div class="p-msg">{{errorMsg}},或点此<span class="c-blue reset-btn" @click="init">刷新</span></div>
              </div>
          </template>
      </div>
    </div> 
