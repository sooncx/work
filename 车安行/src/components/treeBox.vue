<template>
  <div class="treeBox-wrap">
      <tree-item @input="inputValue"  v-model="currentValue" :markIcons="markIcons" @onselected="onselected" :isRadio="false" :model="item" @change="change" :idKey="idKey"  :nameKey="nameKey"   v-if="data&&data.length>0" v-for="item in data">    
...
<script>
// import jsx_treeItem from "@/components/jsx_treeItem";
