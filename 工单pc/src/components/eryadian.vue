  ...
  <div id="app" class="app-wrap">
    <div class="erYaDian_header clr">
      <div class="fl erYaDian_font">二押点
        <span class="iconfont icon-wenti1 c-999 ml-5 pointerStyle" @mouseover="showHelp($event)" @mouseout="hideHelp()"></span>
      </div>
      <div class="fr">
    ...
    <div class="pageFooter">
      ...
      layout="prev, pager, next" :total="this.totalNumber">
      </el-pagination>
    </div>

    <div v-show="isShowHelp" class="helpBox">
      <div class="noticBox">
        <p>
...
export default {
  ...
  methods: {
    ...
    showHelp(event) {
      ...
      helpBox.style.left=(event.clientX-310)+"px";
